package com.busanit501.cyj931111_spring.spring.controller;

import com.busanit501.cyj931111_spring.spring.dto._2_TodoDTO;
import com.busanit501.cyj931111_spring.spring.service.TodoService;
...
public class TodoController {
    ...
    public void list(Model model) {
        ...
        log.info("todo2 list...");
        List<_2_TodoDTO> dtoList = todoService.getAll();
...
//    @GetMapping("/read")
    ...
    public void read(Long tno, Model model) {
        log.info("todo2 read...");
        _2_TodoDTO todoDTO = todoService.getOne(tno);
...
//    @RequestMapping(value = "/register", method = RequestMethod.GET)
    ...
    public String postRegister(@Valid _2_TodoDTO todoDTO, BindingResult bindingResult,
...
//        }
    ...
    @PostMapping("/modify")
    // 유효성 체크시, 주의사항, !) @Valid TodoDTO todoDTO, BindingResult bindingResult, 순서 주의!!!
    public String postModify(@Valid _2_TodoDTO todoDTO, BindingResult bindingResult,
                             RedirectAttributes redirectAttributes) {
        log.info("todo2 register..post");
